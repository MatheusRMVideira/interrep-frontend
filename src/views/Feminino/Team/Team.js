...
class Team extends Component {
    ...
    getOwnData(){
        ...
        .then((response) => {
            this.setState({'femCoins':response.data.fem_coins});
        })
        .catch(function(error) {
            swal("Oops!", error.response.data.error, "error");
        })
    ...
    constructor () {
      ...
      sellAll(){
          ...
          ownCoins += oldValue;
          this.setState({'femCoins':ownCoins});
            ...
            <div className="animated fadeIn" style={{fontFamily: 'Lato', paddingTop: '10px'}}>
                ...
                <Row>
                    <Col xs="12" sm="12" lg="8">
                        ...
                        <Banner title="PATRIMÔNIO: " fontSize="large" boldTitle={"D$"+this.state.femCoins.toFixed(2)} fontWeight="normal" backgroundColor="primary"/>
                    </Col>
